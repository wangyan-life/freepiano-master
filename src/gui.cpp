...
int menu_on_command(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
  ...
  switch (id) {
   ...
   case MENU_ID_HELP_HOMEPAGE:
     ShellExecute(NULL, "open", "https://github.com/wangyan-life/devpiano", NULL, NULL, 0);
     break;
...
int gui_init() {
  ...
  wc.lpszClassName = "DevPianoMainWindow";
  ...
  // create window
  mainhwnd = CreateWindow("DevPianoMainWindow", APP_NAME, style,
