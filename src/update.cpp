...
void update_check_async() {
  ...
  internet = InternetOpen("devpiano 1.8", INTERNET_OPEN_TYPE_PRECONFIG, NULL, NULL, INTERNET_FLAG_ASYNC);
  InternetSetStatusCallback(internet, &internet_status_callback);

  InternetOpenUrl(internet, "http://api.devpiano.com/check_update", NULL, NULL, NULL, 1);
}